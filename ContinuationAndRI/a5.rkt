...
; start from simpler cases:
; try to create a natural number and fib stream first

(define nat$
    (letrec ([k (lambda (ls) 
        (cond
            ((null? ls) ls)
            (else (cons$ (add1 (car$ ls)) (k (cdr$ ls))))))])
        (cons$ 1 (k nat$))))
...
(define fib$
    (letrec ([k (lambda (ls) 
        (cond
            ((null? ls) ls)
            (else (cons$ (+ (car$ ls) (car$ (cdr$ ls))) (k (cdr$ ls))))))])
        (cons$ 1 (cons$ 1 (k fib$)))))
; (take$ 10 nat$)
; (take$ 10 fib$)
...
(define trib$
    (letrec ([k (lambda (ls) 
        (cond
            ((null? ls) ls)
            (else (cons$ (+ (car$ ls) (car$ (cdr$ ls)) (car$ (cdr$ (cdr$ ls)))) (k (cdr$ ls))))))])
        (cons$ 0 (cons$ 1 (cons$ 1 (k trib$))))))
...
(define test
  (lambda ()
    (and (eqv? (value-of-cps '(const 5) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(mult (const 5) (const 5)) (empty-env) (empty-k)) 25)
    (eqv? (value-of-cps '(zero (const 5)) (empty-env) (empty-k)) #f)
    (eqv? (value-of-cps '(sub1 (const 5)) (empty-env) (empty-k)) 4)
    (eqv? (value-of-cps '(sub1 (sub1 (const 5))) (empty-env) (empty-k)) 3)
    (eqv? (value-of-cps '(zero (sub1 (const 6))) (empty-env) (empty-k)) #f)
    (eqv? (value-of-cps '(if (zero (const 5)) (const 3) (mult (const 2) (const 2))) (empty-env) (empty-k)) 4)
    (eqv? (value-of-cps '(if (zero (const 0)) (mult (const 2) (const 2)) (const 3)) (empty-env) (empty-k)) 4)
    (eqv? (value-of-cps '(app (lambda (const 5)) (const 6)) (empty-env) (empty-k)) 5) 
    (eqv? (value-of-cps '(app (lambda (var 0)) (const 5)) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(app (app (lambda (lambda (var 1))) (const 6)) (const 5)) (empty-env) (empty-k)) 6)
    (eqv? (value-of-cps '(app (lambda (app (lambda (var 1)) (const 6))) (const 5)) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(app (lambda (if (zero (var 0)) (const 4) (const 5))) (const 3)) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(let (const 6) (const 4)) (empty-env) (empty-k)) 4)
    (eqv? (value-of-cps '(let (const 5) (var 0)) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(mult (const 5) (let (const 5) (var 0))) (empty-env) (empty-k)) 25)
    (eqv? (value-of-cps '(app (if (zero (const 4)) (lambda (var 0)) (lambda (const 5))) (const 3)) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(app (if (zero (const 0)) (lambda (var 0)) (lambda (const 5))) (const 3)) (empty-env) (empty-k)) 3)
    (eqv? (value-of-cps '(letcc (const 5)) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(letcc (throw (var 0) (const 5))) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(letcc (throw (var 0) (mult (const 5) (const 5)))) (empty-env) (empty-k)) 25)
    (eqv? (value-of-cps '(letcc (throw (app (lambda (var 0)) (var 0)) (mult (const 5) (const 5)))) (empty-env) (empty-k)) 25)
    (eqv? (value-of-cps '(letcc (sub1 (throw (var 0) (const 5)))) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(letcc (throw (throw (var 0) (const 5)) (const 6))) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(letcc (throw (const 5) (throw (var 0) (const 5)))) (empty-env) (empty-k)) 5)
    (eqv? (value-of-cps '(mult (const 3) (letcc (throw (const 5) (throw (var 0) (const 5))))) (empty-env) (empty-k)) 15)
    (eqv? (value-of-cps '(if (zero (const 5)) (app (lambda (app (var 0) (var 0))) (lambda (app (var 0) (var 0)))) (const 4))
                   (empty-env)
                   (empty-k))
     4)
    (eqv? (value-of-cps '(if (zero (const 0)) (const 4) (app (lambda (app (var 0) (var 0))) (lambda (app (var 0) (var 0)))))
                   (empty-env)
                   (empty-k))
     4)
    (eqv? (value-of-cps '(app (lambda (app (app (var 0) (var 0)) (const 2)))
                         (lambda
                             (lambda 
                                 (if (zero (var 0))  
                                     (const 1)
